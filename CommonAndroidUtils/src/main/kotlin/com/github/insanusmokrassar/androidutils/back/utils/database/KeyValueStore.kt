package com.github.insanusmokrassar.androidutils.back.utils.database

import android.content.Context
import android.content.SharedPreferences
import com.github.insanusmokrassar.IObjectK.interfaces.IObject
import com.github.insanusmokrassar.IObjectK.realisations.SimpleIObject
import com.github.insanusmokrassar.androidutils.back.utils.canBeSerializable
import com.github.insanusmokrassar.androidutils.back.utils.deserialize
import com.github.insanusmokrassar.androidutils.back.utils.serialize
...
fun Context.keyValueStore(
    ...
    return com.github.insanusmokrassar.androidutils.back.utils.database.cache[className] ?. get(name) ?.let {
        it
    } ?: {
        com.github.insanusmokrassar.androidutils.back.utils.database.cache.put(
                className,
                mutableMapOf(
                        Pair(
                                name,
                                com.github.insanusmokrassar.androidutils.back.utils.database.KeyValueStore(this, name)
                        )
                )
        )
        keyValueStore(name)
